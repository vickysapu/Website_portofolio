            ...
            <main>
                <div class="container-xl p-5">
                    <div class="d-flex justify-content-between align-items-end">
                        <h2 class="display-6 mb-0">Dashboard</h2>
                    </div>
                    <!-- Divider-->
                    <hr class="mt-2 mb-5" />
                    <div class="row gx-5">
                            ...
                            <div class="card card-raised h-100">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                        <i class="material-icons icon-lg text-primary me-2">topic</i>
                                    </div>
                                    <div class="fs-6 fw-500">Project</div>
                                    <div class="card-text font-monospace mb-3">
                                        <?php
                                        ...
                                        $total = $row['total'];
                                        ?>
                                        <?php echo $total; ?> project tercatat
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-3 mb-5">
                            <div class="card card-raised h-100">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                        <i class="material-icons icon-lg text-primary me-2">person</i>
                                    </div>
                                    <div class="fs-6 fw-500">Pesan</div>
                                    <div class="card-text font-monospace mb-3">12/30 Tasks</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-3 mb-5">
                            <div class="card card-raised h-100">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                        <i class="material-icons icon-lg text-success me-2">fact_check</i>
                                    </div>
                                    <div class="fs-6 fw-500">aplikasi hosting</div>
                                    <div class="card-text font-monospace mb-3">7/7 Tasks</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-3 mb-5">
                            <div class="card h-100 border-2 border-dashed ripple-primary">
                                <div class="card-body d-flex flex-column align-items-center justify-content-center">
                                    ...
                                    <a class="stretched-link fst-button text-decoration-none d-inline-flex align-items-center" data-bs-toggle="modal" data-bs-target="#modalTambahProject">Tambah Project</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex justify-content-between align-items-end">
                        <h2 class="display-6 mb-0">Dokumentasi</h2>
                    </div>
                    <hr class="mt-2 mb-5" />
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="px-4 border-top">
                                                ...
                                                <a href="../assets/hapusProject.php?id=<?php echo $row['id_project']; ?>&status=dashboard" class="btn" onclick="return confirm('apakah kamu yakin untuk menghapus?')">
                                                    &#10006;
                                                </a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <div class="mb-3">
                            <label for="file_preview" class="form-label">Pratinjau File</label>
                            <div id="file_preview" class="text-center">
                            </div>
                        </div>
    ...
    <div class="modal fade" id="modalTambahProject" tabindex="-1" aria-labelledby="modalTambahProjectLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="../assets/tambah_project.php?status=dashboard" method="POST" enctype="multipart/form-data">
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            editButtons.forEach(button => {
                button.addEventListener("click", function() {
                    ...
                    const id_project = this.getAttribute("data-id");
                    ...
                    modal.querySelector("#id_project").value = id_project || "-";
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            previewButtons.forEach(button => {
                button.addEventListener("click", function() {
                    ...
                    // Pratinjau file
                    const filePreviewContainer = modal.querySelector("#file_preview");
                    filePreviewContainer.innerHTML = ""; // Bersihkan kontainer sebelumnya

                    const filePath = `../assets/file_project/${foto}`;
                    const fileExtension = foto.split('.').pop().toLowerCase();

                    if (["jpg", "jpeg", "png", "gif", "webp"].includes(fileExtension)) {
                        filePreviewContainer.innerHTML = `<img src="${filePath}" alt="Project Image" class="img-fluid rounded">`;
                    ...
                    `;
                        ...
                        filePreviewContainer.innerHTML = `
                        <iframe src="${filePath}" class="w-100" style="height: 400px;" frameborder="0">
